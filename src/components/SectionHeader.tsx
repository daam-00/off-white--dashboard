  ...
  return (
    <div className={cn("mb-6 md:mb-8", className)}>
      ...
      <div className="flex items-center gap-4">
        <h2 className="text-2xl md:text-3xl font-black tracking-tighter uppercase leading-none offwhite-header-title">
          {title}
        </h2>
        <div className="flex-1 h-0.5 bg-black" />
        <div className="offwhite-barcode shrink-0 hidden sm:block" />
      </div>
      {subtitle ? (
