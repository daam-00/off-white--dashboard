...
export const PROFILE_AVATARS: ProfileAvatar[] = [
  ...
  /* ── INVINCIBLE ───────────────────────────────────────────────── */
  {
    ...
    name: 'Mark Grayson',
    series: 'Invincible',
    // Official Amazon Invincible wiki PNG
    imageUrl: 'https://static.wikia.nocookie.net/amazon-invincible/images/a/a3/Invincible_%28Mark_Grayson%29.png/revision/latest/scale-to-width-down/200?cb=20231228121029',
    cost: 1000,
    rarity: 'epic',
    bgColor: '#1e3a8a',
  },
  {
    ...
    series: 'Invincible',
    // Official Amazon Invincible wiki PNG
    imageUrl: 'https://static.wikia.nocookie.net/amazon-invincible/images/6/63/Omni-ManProfile.png/revision/latest/scale-to-width-down/200?cb=20210619064910',
    cost: 1500,
    rarity: 'legendary',
    bgColor: '#8b0000',
  },
  {
    id: 'invincible-viltrumite',
    name: 'Viltrumite',
    series: 'Invincible',
    imageUrl: 'https://api.dicebear.com/7.x/bottts/svg?seed=viltrumitewarrior99&backgroundColor=4a0000&radius=50',
    cost: 1200,
    rarity: 'legendary',
    bgColor: '#4a0000',
  },
